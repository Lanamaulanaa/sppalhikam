...
<html lang="en">
  <head>
    ...
    <title>Tambah Data SPP - Aplikasi Pembayaran SPP</title>
  ...
  <main>
   ...
   <section id="add-officer" class="mx-3">
    ...
    <h2 class="my-3">Tambah Data SPP</h2>
    ...
    <form action="" class="my-3" method="post">
    	...
    	<input type="number" name="tahun" id="tahun" class="form-control mb-3" autocomplete="off" required>

      <label for="nominal" class="mb-2">Nominal</label>
      <input type="number" name="nominal" id="nominal" class="form-control mb-3" autocomplete="off" required>
