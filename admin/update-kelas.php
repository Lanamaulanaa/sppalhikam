  ...
  <main>
   ...
   <section id="today-transaction" class="mx-3">
    ...
    <form action="" method="post">
      ...
      <label for="komp-keahlian">Tingkat/Jurusan</label>
      <select required name="komp-keahlian" id="komp-keahlian" class="form-select mt-2 mb-3">
        ...
        <option value="Madrasah Aliyah (IPA)">Madrasah Aliyah (IPA)</option>
        <option value="Madrasah Aliyah (IPS)">Madrasah Aliyah (IPS)</option>
      </select>
