...
<html lang="en">
  <head>
    ...
    <title>Tambah data petugas - Aplikasi Pembayaran SPP</title>
  ...
  <main>
   ...
   <section id="add-officer" class="mx-3">
    ...
    <h2 class="my-3">Tambah petugas</h2>
    ...
    <form action="" method="post" class="my-3">
    	...
    	<input type="text" autocomplete="off" name="nama" id="nama" class="form-control mb-3" required>

    	<label for="username" class="mb-2">Username</label>
    	<input type="text" autocomplete="off" name="username" id="username" class="form-control mb-3" required>

    	<label for="password" class="mb-2">Password</label>
    	<input type="text" autocomplete="off" name="password" id="password" class="form-control mb-3" required>
    	...
    	<button name="tambah" type="submit" class="btn me-3 btn-primary">Tambahkan</a>
    </form>
